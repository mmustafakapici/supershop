					...
					if(isset($_POST['discount_amnt']))
					{
						if(@$getDiscount > 0) {
							...
							<div class="alert alert-success alert-dismissible fade show" role="alert">
								<strong>Congratulation!</strong> You have get TL '. @$_SESSION['SSCF_DISCOUNT_AMOUNT'] .' tk discount.
					...
					<form action="" method="post">
						<div class="input-group">
							<select class="form-control" name="shipping_method">
								...
								<option value="50">  shipping 50 TL Inside of Mersin </option>
								<option value="120"> shipping 120 TL Outside of Mersin</option>
							</select>
							<div class="input-group-append">
