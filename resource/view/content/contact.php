			...
			<script type="text/javascript">
				...
				function init() {
					...
					var mapOptions = {
						...
						center: new google.maps.LatLng(36.791808687493244, 34.59581558962058), // New York
				...
				var marker = new google.maps.Marker({map: map,position: new google.maps.LatLng(36.791808687493244, 34.59581558962058)});infowindow = new google.maps.InfoWindow({content:"<b>https://toros.edu.tr</b><br/>45 evler Kampüsü<br/> Toros üniversitesi" });google.maps.event.addListener(marker, "click", function(){infowindow.open(map,marker);});infowindow.open(map,marker);}google.maps.event.addDomListener(window, 'load', init_map);
			</script>
			...
			<div class="col-md-4">
				...
				<div class="contact-info">
					<div>
						...
						<p><a href="tel:">+90 545 292 2209</a></p>
						<p>Cell Number</p>
					</div>
					<div>
					...
					<div>
						...
						<p><a href="mailto:#">m.mustafakapici@gmail.com</a></p>
						<p><a href="mailto:#">ug.mustafa.kapici@toros.edu.tr</a></p>
					</div>
					<div>
