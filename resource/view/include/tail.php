							...
							<div class="col-lg-4 col-md-6">
								<div class="widget">
									<ul class="contact-info">
										<li><span class="contact-info-label">Address:</span>45 Evler Kapmüsü , Toros Üniversitesi , 33110 , Mersin</li>
										<li><span class="contact-info-label">Phone:</span>Toll Free <a href="tel:">+90 545 292 2209</a></li>
										<li><span class="contact-info-label">Email:</span> <a href="mailto:mail@example.com">ug.mustafa.kapici@toros.edu.tr</a></li>
				...
				<div class="container">
					<div class="footer-bottom">
						<p class="footer-copyright mt-1">All Rights Reserved &copy; <?= date('Y') ?> | Developed By
							<a href="//" target="_blank"> Mustafa KAPICI</a>
						</p>
						...
						<div class="social-icons">
							...
							<a href="https://www.linkedin.com/in/mmustafa-kapici" class="social-icon" target="_blank">
		...
		<div class="mobile-menu-container">
			<div class="mobile-menu-wrapper">
				...
				<div class="social-icons">
					...
					<a href="https://www.linkedin.com/in/" class="social-icon" target="_blank">
						<i class="icon-linkedin"></i>
					</a>
					<a href="https://twitter.com/" class="social-icon" target="_blank">
						<i class="icon-twitter"></i>
